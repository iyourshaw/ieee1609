...
#include "EUTRA-RRC-Definitions_UEAssistanceInformation-v1430-IEs.h"

#include "EUTRA-RRC-Definitions_BW-Preference-r14.h"
#include "EUTRA-RRC-Definitions_DelayBudgetReport-r14.h"
#include "EUTRA-RRC-Definitions_UEAssistanceInformation-v1450-IEs.h"
#include "EUTRA-RRC-Definitions_TrafficPatternInfoList-r14.h"
/*
...
static asn_TYPE_member_t asn_MBR_sps_AssistanceInformation_r14_3[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__sps_AssistanceInformation_r14, trafficPatternInfoListSL_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__sps_AssistanceInformation_r14, trafficPatternInfoListUL_r14),
...
static asn_SEQUENCE_specifics_t asn_SPC_sps_AssistanceInformation_r14_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__sps_AssistanceInformation_r14),
	offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__sps_AssistanceInformation_r14, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_rlm_Event_r14_7 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rlm_Event_r14_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_excessRep_MPDCCH_r14_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_excessRep_MPDCCH_r14_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_rlm_Report_r14_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__rlm_Report_r14, rlm_Event_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__rlm_Report_r14, excessRep_MPDCCH_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_rlm_Report_r14_specs_6 = {
	sizeof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__rlm_Report_r14),
	offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs__rlm_Report_r14, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_1[] = {
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, bw_Preference_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, sps_AssistanceInformation_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, rlm_Report_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, delayBudgetReport_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_oms_1[] = { 0, 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs),
	offsetof(struct EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs = {
	"UEAssistanceInformation-v1430-IEs",
	"UEAssistanceInformation-v1430-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_1,
	5,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UEAssistanceInformation_v1430_IEs_specs_1	/* Additional specs */
};
