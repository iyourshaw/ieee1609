...
#include "EUTRA-RRC-Definitions_SPUCCH-Set-r15.h"
/*
...
static asn_oer_constraints_t asn_OER_type_twoAntennaPortActivatedSPUCCH_Format1a1b_r15_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_n3SPUCCH_AN_List_r15_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_SPUCCH_Config_r15_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_SPUCCH_Config_r15_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_twoAntennaPortActivatedSPUCCH_Format1a1b_r15_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_twoAntennaPortActivatedSPUCCH_Format1a1b_r15_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_n3SPUCCH_AN_List_r15_specs_8 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup__dummy__n3SPUCCH_AN_List_r15),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup__dummy__n3SPUCCH_AN_List_r15, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_n3SPUCCH_AN_List_r15_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_n3SPUCCH_AN_List_r15_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_dummy_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup__dummy, n3SPUCCH_AN_List_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_dummy_specs_7 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup__dummy),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup__dummy, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup, spucch_Set_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup, twoAntennaPortActivatedSPUCCH_Format1a1b_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup, dummy),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_dummy_7,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_setup_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15__setup, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SPUCCH_Config_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15, choice.release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SPUCCH_Config_r15_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SPUCCH_Config_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_r15, present),
	sizeof(((struct EUTRA_RRC_Definitions_SPUCCH_Config_r15 *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_SPUCCH_Config_r15_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SPUCCH_Config_r15 = {
	"SPUCCH-Config-r15",
	"SPUCCH-Config-r15",
	&asn_OP_CHOICE,
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_SPUCCH_Config_r15_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_SPUCCH_Config_r15_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_SPUCCH_Config_r15_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SPUCCH_Config_r15_specs_1	/* Additional specs */
};
