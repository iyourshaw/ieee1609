...
#include "EUTRA-RRC-Definitions_MeasResultServFreq-r13.h"

static asn_TYPE_member_t asn_MBR_measResultSCell_r13_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultSCell_r13, rsrpResultSCell_r13),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultSCell_r13, rsrqResultSCell_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultSCell_r13, rs_sinr_Result_r13),
...
static asn_SEQUENCE_specifics_t asn_SPC_measResultSCell_r13_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultSCell_r13),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultSCell_r13, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_measResultBestNeighCell_r13_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13, physCellId_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13, rsrpResultNCell_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_RSRP_Range,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13, rsrqResultNCell_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_RSRQ_Range_r13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13, rs_sinr_Result_r13),
...
static asn_SEQUENCE_specifics_t asn_SPC_measResultBestNeighCell_r13_specs_7 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__measResultBestNeighCell_r13, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_measResultBestNeighCell_v1360_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1__measResultBestNeighCell_v1360, rsrpResultNCell_v1360),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_measResultBestNeighCell_v1360_specs_14 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1__measResultBestNeighCell_v1360),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1__measResultBestNeighCell_v1360, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext1_13[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1, measResultBestNeighCell_v1360),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_13 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MeasResultServFreq_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13, servFreqId_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13, measResultSCell_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13, measResultBestNeighCell_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_13,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_MeasResultServFreq_r13_oms_1[] = { 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MeasResultServFreq_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultServFreq_r13, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_MeasResultServFreq_r13_oms_1,	/* Optional members */
	2, 1,	/* Root/Additions */
	3,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13 = {
	"MeasResultServFreq-r13",
	"MeasResultServFreq-r13",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultServFreq_r13_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MeasResultServFreq_r13_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MeasResultServFreq_r13_specs_1	/* Additional specs */
};
