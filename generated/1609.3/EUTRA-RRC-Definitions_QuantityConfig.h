...
#ifndef	_EUTRA_RRC_Definitions_QuantityConfig_H_
#define	_EUTRA_RRC_Definitions_QuantityConfig_H_
...
/* EUTRA-RRC-Definitions_QuantityConfig */
typedef struct EUTRA_RRC_Definitions_QuantityConfig {
	 ...
	 */
	struct EUTRA_RRC_Definitions_QuantityConfig__ext1 {
		struct QuantityConfigUTRA_v1020	*quantityConfigUTRA_v1020;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext1;
	struct EUTRA_RRC_Definitions_QuantityConfig__ext2 {
		struct QuantityConfigEUTRA_v1250	*quantityConfigEUTRA_v1250;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext2;
	struct EUTRA_RRC_Definitions_QuantityConfig__ext3 {
	...
	struct EUTRA_RRC_Definitions_QuantityConfig__ext4 {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} EUTRA_RRC_Definitions_QuantityConfig_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_QuantityConfig;
extern asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_QuantityConfig_specs_1;
extern asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_QuantityConfig_1[8];

#ifdef __cplusplus
}
#endif

#endif	/* _EUTRA_RRC_Definitions_QuantityConfig_H_ */
