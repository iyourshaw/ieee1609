...
#include "EUTRA-RRC-Definitions_PURConfigurationRequest-r16-IEs.h"
...
static asn_oer_constraints_t asn_OER_type_requestedNumOccasions_r16_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_requestedTBS_r16_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_rrc_ACK_r16_constr_74 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_pur_ConfigRequest_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_requestedNumOccasions_r16_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_requestedNumOccasions_r16_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_requestedTBS_r16_9 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_requestedTBS_r16_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_rrc_ACK_r16_74 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rrc_ACK_r16_constr_74,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_pur_SetupRequest_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest, requestedNumOccasions_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest, requestedPeriodicityAndOffset_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest, requestedTBS_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest, rrc_ACK_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_pur_SetupRequest_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest),
	offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16__pur_SetupRequest, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_pur_ConfigRequest_r16_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16, choice.pur_ReleaseRequest),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16, choice.pur_SetupRequest),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_pur_ConfigRequest_r16_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16),
	offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16, present),
	sizeof(((struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__pur_ConfigRequest_r16 *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_pur_ConfigRequest_r16_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_pur_ConfigRequest_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_77 = {
	sizeof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__nonCriticalExtension),
	offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs, pur_ConfigRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pur-ConfigRequest-r16 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* lateNonCriticalExtension */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs),
	offsetof(struct EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs = {
	"PURConfigurationRequest-r16-IEs",
	"PURConfigurationRequest-r16-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PURConfigurationRequest_r16_IEs_specs_1	/* Additional specs */
};
