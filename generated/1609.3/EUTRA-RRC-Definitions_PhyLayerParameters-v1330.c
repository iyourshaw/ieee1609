...
asn_TYPE_descriptor_t asn_DEF_cch_InterfMitigation_RefRecTypeA_r13_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cch_InterfMitigation_RefRecTypeA_r13_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cch_InterfMitigation_RefRecTypeB_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cch_InterfMitigation_RefRecTypeB_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_1[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330, cch_InterfMitigation_RefRecTypeA_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330, cch_InterfMitigation_RefRecTypeB_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330, cch_InterfMitigation_MaxNumCCs_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_cch_InterfMitigation_MaxNumCCs_r13_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330, crs_InterfMitigationTM1toTM9_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_crs_InterfMitigationTM1toTM9_r13_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const int asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330),
	offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1330, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330 = {
	"PhyLayerParameters-v1330",
	"PhyLayerParameters-v1330",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PhyLayerParameters_v1330_specs_1	/* Additional specs */
};
