...
static asn_oer_constraints_t asn_OER_type_aul_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_laa_PUSCH_Mode1_r15_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_laa_PUSCH_Mode2_r15_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_laa_PUSCH_Mode3_r15_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_laa_PUSCH_Mode1_r15_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_laa_PUSCH_Mode1_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_laa_PUSCH_Mode2_r15_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_laa_PUSCH_Mode2_r15_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_laa_PUSCH_Mode3_r15_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_laa_PUSCH_Mode3_r15_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_LAA_Parameters_v1530_1[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530, aul_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530, laa_PUSCH_Mode1_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530, laa_PUSCH_Mode2_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530, laa_PUSCH_Mode3_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_LAA_Parameters_v1530_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_LAA_Parameters_v1530_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530),
	offsetof(struct EUTRA_RRC_Definitions_LAA_Parameters_v1530, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_LAA_Parameters_v1530_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530 = {
	"LAA-Parameters-v1530",
	"LAA-Parameters-v1530",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_LAA_Parameters_v1530_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_LAA_Parameters_v1530_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_LAA_Parameters_v1530_specs_1	/* Additional specs */
};
