...
#include "EUTRA-RRC-Definitions_SupportedBandListEUTRA-v1310.h"
#include "EUTRA-RRC-Definitions_SupportedBandCombinationReduced-r13.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_reducedIntNonContCombRequested_r13_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_reducedIntNonContCombRequested_r13_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipFallbackCombRequested_r13_7 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipFallbackCombRequested_r13_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_eNB_RequestedParameters_r13_2[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13, reducedIntNonContCombRequested_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13, requestedCCsDL_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_requestedCCsDL_r13_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13, requestedCCsUL_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_requestedCCsUL_r13_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13, skipFallbackCombRequested_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_eNB_RequestedParameters_r13_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13),
	offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310__eNB_RequestedParameters_r13, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_maximumCCsRetrieval_r13_9 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_maximumCCsRetrieval_r13_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipFallbackCombinations_r13_11 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipFallbackCombinations_r13_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_reducedIntNonContComb_r13_13 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_reducedIntNonContComb_r13_constr_13,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RF_Parameters_v1310_1[] = {
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, eNB_RequestedParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, maximumCCsRetrieval_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, skipFallbackCombinations_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, reducedIntNonContComb_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, supportedBandListEUTRA_v1310),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, supportedBandCombinationReduced_r13),
...
static const int asn_MAP_EUTRA_RRC_Definitions_RF_Parameters_v1310_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RF_Parameters_v1310_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RF_Parameters_v1310_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310),
	offsetof(struct EUTRA_RRC_Definitions_RF_Parameters_v1310, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RF_Parameters_v1310_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RF_Parameters_v1310_oms_1,	/* Optional members */
	6, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310 = {
	"RF-Parameters-v1310",
	"RF-Parameters-v1310",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RF_Parameters_v1310_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RF_Parameters_v1310_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RF_Parameters_v1310_specs_1	/* Additional specs */
};
