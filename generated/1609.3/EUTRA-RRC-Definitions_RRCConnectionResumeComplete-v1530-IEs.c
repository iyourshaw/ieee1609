...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_1[] = {
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, logMeasAvailableBT_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, logMeasAvailableWLAN_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, idleMeasAvailable_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, flightPathInfoAvailable_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_oms_1[] = { 0, 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs),
	offsetof(struct EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs = {
	"RRCConnectionResumeComplete-v1530-IEs",
	"RRCConnectionResumeComplete-v1530-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_1,
	5,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RRCConnectionResumeComplete_v1530_IEs_specs_1	/* Additional specs */
};
