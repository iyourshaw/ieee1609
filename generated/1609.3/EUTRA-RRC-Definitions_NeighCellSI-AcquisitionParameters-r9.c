...
asn_TYPE_descriptor_t asn_DEF_intraFreqSI_AcquisitionForHO_r9_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_intraFreqSI_AcquisitionForHO_r9_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_interFreqSI_AcquisitionForHO_r9_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_interFreqSI_AcquisitionForHO_r9_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_utran_SI_AcquisitionForHO_r9_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_utran_SI_AcquisitionForHO_r9_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9, intraFreqSI_AcquisitionForHO_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9, interFreqSI_AcquisitionForHO_r9),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9, utran_SI_AcquisitionForHO_r9),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9),
	offsetof(struct EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9 = {
	"NeighCellSI-AcquisitionParameters-r9",
	"NeighCellSI-AcquisitionParameters-r9",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_NeighCellSI_AcquisitionParameters_r9_specs_1	/* Additional specs */
};
