...
asn_TYPE_descriptor_t asn_DEF_cyclicShiftAp_v1310_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cyclicShiftAp_v1310_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_transmissionCombNum_r13_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_transmissionCombNum_r13_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_v1310, transmissionCombAp_v1310),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_transmissionCombAp_v1310_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_v1310, cyclicShiftAp_v1310),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_v1310, transmissionCombNum_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_v1310),
	offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_v1310, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310 = {
	"SRS-ConfigAp-v1310",
	"SRS-ConfigAp-v1310",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SRS_ConfigAp_v1310_specs_1	/* Additional specs */
};
