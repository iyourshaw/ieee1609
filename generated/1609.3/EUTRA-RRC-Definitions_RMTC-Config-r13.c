...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_RMTC_Config_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_RMTC_Config_r13_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_rmtc_Period_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rmtc_Period_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_measDuration_r13_11 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_measDuration_r13_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13__setup, rmtc_Period_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13__setup, rmtc_SubframeOffset_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_rmtc_SubframeOffset_r13_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13__setup, measDuration_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_setup_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_RMTC_Config_r13__setup),
	offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13__setup, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RMTC_Config_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13, choice.release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RMTC_Config_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RMTC_Config_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RMTC_Config_r13),
	offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_RMTC_Config_r13, present),
	sizeof(((struct EUTRA_RRC_Definitions_RMTC_Config_r13 *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_RMTC_Config_r13_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RMTC_Config_r13 = {
	"RMTC-Config-r13",
	"RMTC-Config-r13",
	&asn_OP_CHOICE,
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_RMTC_Config_r13_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_RMTC_Config_r13_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_RMTC_Config_r13_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RMTC_Config_r13_specs_1	/* Additional specs */
};
