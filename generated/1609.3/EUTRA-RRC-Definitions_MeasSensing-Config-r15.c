...
asn_TYPE_descriptor_t asn_DEF_sensingPeriodicity_r15_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_sensingPeriodicity_r15_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MeasSensing_Config_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15, sensingSubchannelNumber_r15),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sensingSubchannelNumber_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15, sensingPeriodicity_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15, sensingReselectionCounter_r15),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sensingReselectionCounter_r15_constr_16,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15, sensingPriority_r15),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sensingPriority_r15_constr_17,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MeasSensing_Config_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15),
	offsetof(struct EUTRA_RRC_Definitions_MeasSensing_Config_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tag2el_1,
	4,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15 = {
	"MeasSensing-Config-r15",
	"MeasSensing-Config-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasSensing_Config_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MeasSensing_Config_r15_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MeasSensing_Config_r15_specs_1	/* Additional specs */
};
