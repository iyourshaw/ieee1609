...
asn_TYPE_descriptor_t asn_DEF_deltaMCS_Enabled_r10_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaMCS_Enabled_r10_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static int asn_DFL_9_cmp_4(const void *sptr) {
	const EUTRA_RRC_Definitions_FilterCoefficient_t *st = sptr;
...
static int asn_DFL_9_set_4(void **sptr) {
	EUTRA_RRC_Definitions_FilterCoefficient_t *st = *sptr;
...
asn_TYPE_descriptor_t asn_DEF_pathlossReferenceLinking_r10_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_pathlossReferenceLinking_r10_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, p0_UE_PUSCH_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_p0_UE_PUSCH_r10_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, deltaMCS_Enabled_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, accumulationEnabled_r10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, pSRS_Offset_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_pSRS_Offset_r10_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, pSRS_OffsetAp_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_pSRS_OffsetAp_r10_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, filterCoefficient_r10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, pathlossReferenceLinking_r10),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_oms_1[] = { 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10),
	offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10 = {
	"UplinkPowerControlDedicatedSCell-r10",
	"UplinkPowerControlDedicatedSCell-r10",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UplinkPowerControlDedicatedSCell_r10_specs_1	/* Additional specs */
};
