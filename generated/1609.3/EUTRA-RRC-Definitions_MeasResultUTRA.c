...
#include "EUTRA-RRC-Definitions_MeasResultUTRA.h"
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_primaryPLMN_Suitable_r12_constr_17 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_physCellId_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId, choice.fdd),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId, choice.tdd),
...
static asn_CHOICE_specifics_t asn_SPC_physCellId_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId, present),
	sizeof(((struct EUTRA_RRC_Definitions_MeasResultUTRA__physCellId *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_physCellId_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_physCellId_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_cgi_Info_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info, cellGlobalId),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info, locationAreaCode),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_locationAreaCode_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info, routingAreaCode),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_routingAreaCode_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info, plmn_IdentityList),
...
static asn_SEQUENCE_specifics_t asn_SPC_cgi_Info_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__cgi_Info, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext1_14[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext1, additionalSI_Info_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_14 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext1),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext1, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_primaryPLMN_Suitable_r12_17 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_primaryPLMN_Suitable_r12_constr_17,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext2_16[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext2, primaryPLMN_Suitable_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_16 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext2),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_measResult_10[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult, utra_RSCP),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_utra_RSCP_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult, utra_EcN0),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_utra_EcN0_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_14,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_16,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_measResult_specs_10 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA__measResult, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MeasResultUTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA, physCellId),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA, cgi_Info),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_cgi_Info_5,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA, measResult),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_MeasResultUTRA_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MeasResultUTRA_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MeasResultUTRA_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MeasResultUTRA),
	offsetof(struct EUTRA_RRC_Definitions_MeasResultUTRA, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MeasResultUTRA_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_MeasResultUTRA_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA = {
	"MeasResultUTRA",
	"MeasResultUTRA",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MeasResultUTRA_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MeasResultUTRA_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MeasResultUTRA_specs_1	/* Additional specs */
};
