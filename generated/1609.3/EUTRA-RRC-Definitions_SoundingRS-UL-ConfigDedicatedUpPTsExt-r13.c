...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_srs_Bandwidth_r13_7 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_srs_Bandwidth_r13_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_srs_HoppingBandwidth_r13_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_srs_HoppingBandwidth_r13_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cyclicShift_r13_21 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cyclicShift_r13_constr_21,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_transmissionCombNum_r13_35 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_transmissionCombNum_r13_constr_35,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, srs_UpPtsAdd_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, srs_Bandwidth_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, srs_HoppingBandwidth_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, freqDomainPosition_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_freqDomainPosition_r13_constr_17,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, duration_r13),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, srs_ConfigIndex_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_srs_ConfigIndex_r13_constr_19,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, transmissionComb_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_transmissionComb_r13_constr_20,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, cyclicShift_r13),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, srs_AntennaPort_r13),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, transmissionCombNum_r13),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_setup_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup),
	offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13__setup, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13, choice.release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13),
	offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13, present),
	sizeof(((struct EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13 *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SoundingRS_UL_ConfigDedicatedUpPTsExt_r13_specs_1	/* Additional specs */
};
