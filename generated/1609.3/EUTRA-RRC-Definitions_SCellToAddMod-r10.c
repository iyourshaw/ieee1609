...
#include "EUTRA-RRC-Definitions_SCellToAddMod-r10.h"
...
static asn_oer_constraints_t asn_OER_memb_srs_SwitchFromServCellIndex_r14_constr_14 CC_NOTUSED = {
	{ 1, 1 }	/* (0..31) */,
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_sCellState_r15_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_cellIdentification_r10_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__cellIdentification_r10, physCellId_r10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__cellIdentification_r10, dl_CarrierFreq_r10),
...
static asn_SEQUENCE_specifics_t asn_SPC_cellIdentification_r10_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__cellIdentification_r10),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__cellIdentification_r10, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext1, dl_CarrierFreq_v1090),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_9 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext1),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext1, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext2, antennaInfoDedicatedSCell_v10i0),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_11 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext2),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_13[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext3, srs_SwitchFromServCellIndex_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_srs_SwitchFromServCellIndex_r14_constr_14,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_13 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext3),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext3, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_sCellState_r15_16 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_sCellState_r15_constr_16,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext4_15[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext4, sCellState_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext4_specs_15 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext4),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10__ext4, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SCellToAddMod_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, sCellIndex_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, cellIdentification_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, radioResourceConfigCommonSCell_r10),
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, radioResourceConfigDedicatedSCell_r10),
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_15,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_SCellToAddMod_r10_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SCellToAddMod_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SCellToAddMod_r10_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10),
	offsetof(struct EUTRA_RRC_Definitions_SCellToAddMod_r10, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SCellToAddMod_r10_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SCellToAddMod_r10_oms_1,	/* Optional members */
	3, 4,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10 = {
	"SCellToAddMod-r10",
	"SCellToAddMod-r10",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SCellToAddMod_r10_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SCellToAddMod_r10_1,
	8,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SCellToAddMod_r10_specs_1	/* Additional specs */
};
