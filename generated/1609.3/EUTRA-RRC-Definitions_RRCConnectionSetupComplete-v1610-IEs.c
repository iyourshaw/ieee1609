...
#include "EUTRA-RRC-Definitions_RRCConnectionSetupComplete-v1610-IEs.h"
...
static asn_oer_constraints_t asn_OER_type_rlos_Request_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_cp_CIoT_5GS_Optimisation_r16_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_up_CIoT_5GS_Optimisation_r16_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_lte_M_r16_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_iab_NodeIndication_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_iab_NodeIndication_constr_11 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_rlos_Request_r16_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rlos_Request_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cp_CIoT_5GS_Optimisation_r16_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cp_CIoT_5GS_Optimisation_r16_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_up_CIoT_5GS_Optimisation_r16_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_up_CIoT_5GS_Optimisation_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_lte_M_r16_9 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_lte_M_r16_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const asn_INTEGER_enum_map_t asn_MAP_iab_NodeIndication_value2enum_11[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_iab_NodeIndication_enum2value_11[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_iab_NodeIndication_specs_11 = {
	asn_MAP_iab_NodeIndication_value2enum_11,	/* "tag" => N; sorted by tag */
	asn_MAP_iab_NodeIndication_enum2value_11,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_iab_NodeIndication_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_iab_NodeIndication_11 = {
	"iab-NodeIndication",
	"iab-NodeIndication",
	&asn_OP_NativeEnumerated,
	asn_DEF_iab_NodeIndication_tags_11,
	sizeof(asn_DEF_iab_NodeIndication_tags_11)
		/sizeof(asn_DEF_iab_NodeIndication_tags_11[0]) - 1, /* 1 */
	asn_DEF_iab_NodeIndication_tags_11,	/* Same as above */
	sizeof(asn_DEF_iab_NodeIndication_tags_11)
		/sizeof(asn_DEF_iab_NodeIndication_tags_11[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_iab_NodeIndication_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_iab_NodeIndication_constr_11,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		NativeEnumerated_constraint
	},
	0, 0,	/* Defined elsewhere */
	&asn_SPC_iab_NodeIndication_specs_11	/* Additional specs */
};
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_13 = {
	sizeof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs__nonCriticalExtension),
	offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_1[] = {
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, rlos_Request_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, cp_CIoT_5GS_Optimisation_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, up_CIoT_5GS_Optimisation_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, pur_ConfigID_r16),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, lte_M_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_lte_M_r16_9,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, iab_NodeIndication),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_iab_NodeIndication_11,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* iab-NodeIndication */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs),
	offsetof(struct EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_oms_1,	/* Optional members */
	7, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs = {
	"RRCConnectionSetupComplete-v1610-IEs",
	"RRCConnectionSetupComplete-v1610-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RRCConnectionSetupComplete_v1610_IEs_specs_1	/* Additional specs */
};
