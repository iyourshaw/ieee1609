...
asn_TYPE_descriptor_t asn_DEF_probResourceKeep_r14_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_probResourceKeep_r14_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_p2x_SensingConfig_r14_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14__p2x_SensingConfig_r14, minNumCandidateSF_r14),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_minNumCandidateSF_r14_constr_15,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14__p2x_SensingConfig_r14, gapCandidateSensing_r14),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_gapCandidateSensing_r14_constr_16,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_p2x_SensingConfig_r14_specs_14 = {
	sizeof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14__p2x_SensingConfig_r14),
	offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14__p2x_SensingConfig_r14, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_sl_ReselectAfter_r14_17 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_sl_ReselectAfter_r14_constr_17,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, pssch_TxConfigList_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, thresPSSCH_RSRP_List_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, restrictResourceReservationPeriod_r14),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, probResourceKeep_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, p2x_SensingConfig_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, sl_ReselectAfter_r14),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_oms_1[] = { 2, 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14),
	offsetof(struct EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14 = {
	"SL-CommTxPoolSensingConfig-r14",
	"SL-CommTxPoolSensingConfig-r14",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SL_CommTxPoolSensingConfig_r14_specs_1	/* Additional specs */
};
