...
#include "EUTRA-RRC-Definitions_IntraBandContiguousCC-Info-r12.h"
/*
...
static asn_oer_constraints_t asn_OER_type_fourLayerTM3_TM4_r15_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_intraBandContiguousCC_InfoList_r15_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_intraBandContiguousCC_InfoList_r15_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_fourLayerTM3_TM4_r15_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_fourLayerTM3_TM4_r15_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_intraBandContiguousCC_InfoList_r15_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15__intraBandContiguousCC_InfoList_r15),
	offsetof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15__intraBandContiguousCC_InfoList_r15, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_intraBandContiguousCC_InfoList_r15_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_intraBandContiguousCC_InfoList_r15_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15, supportedMIMO_CapabilityDL_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15, fourLayerTM3_TM4_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15, intraBandContiguousCC_InfoList_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_intraBandContiguousCC_InfoList_r15_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const int asn_MAP_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15),
	offsetof(struct EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15 = {
	"CA-MIMO-ParametersDL-r15",
	"CA-MIMO-ParametersDL-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_CA_MIMO_ParametersDL_r15_specs_1	/* Additional specs */
};
