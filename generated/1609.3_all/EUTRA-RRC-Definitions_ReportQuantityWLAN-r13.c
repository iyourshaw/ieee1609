...
asn_TYPE_descriptor_t asn_DEF_bandRequestWLAN_r13_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_bandRequestWLAN_r13_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_carrierInfoRequestWLAN_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_carrierInfoRequestWLAN_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_availableAdmissionCapacityRequestWLAN_r13_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_availableAdmissionCapacityRequestWLAN_r13_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_backhaulDL_BandwidthRequestWLAN_r13_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_backhaulDL_BandwidthRequestWLAN_r13_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_backhaulUL_BandwidthRequestWLAN_r13_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_backhaulUL_BandwidthRequestWLAN_r13_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_channelUtilizationRequestWLAN_r13_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_channelUtilizationRequestWLAN_r13_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_stationCountRequestWLAN_r13_14 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_stationCountRequestWLAN_r13_constr_14,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_1[] = {
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, bandRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, carrierInfoRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, availableAdmissionCapacityRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, backhaulDL_BandwidthRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, backhaulUL_BandwidthRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, channelUtilizationRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, stationCountRequestWLAN_r13),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13),
	offsetof(struct EUTRA_RRC_Definitions_ReportQuantityWLAN_r13, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_oms_1,	/* Optional members */
	7, 0,	/* Root/Additions */
	7,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13 = {
	"ReportQuantityWLAN-r13",
	"ReportQuantityWLAN-r13",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_ReportQuantityWLAN_r13_specs_1	/* Additional specs */
};
