...
#include "EUTRA-RRC-Definitions_CIOT-OptimisationPLMN-r13.h"
...
asn_TYPE_descriptor_t asn_DEF_up_CIoT_EPS_Optimisation_r13_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_up_CIoT_EPS_Optimisation_r13_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cp_CIoT_EPS_Optimisation_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cp_CIoT_EPS_Optimisation_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_attachWithoutPDN_Connectivity_r13_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_attachWithoutPDN_Connectivity_r13_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13, up_CIoT_EPS_Optimisation_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13, cp_CIoT_EPS_Optimisation_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13, attachWithoutPDN_Connectivity_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13),
	offsetof(struct EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13 = {
	"CIOT-OptimisationPLMN-r13",
	"CIOT-OptimisationPLMN-r13",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_CIOT_OptimisationPLMN_r13_specs_1	/* Additional specs */
};
