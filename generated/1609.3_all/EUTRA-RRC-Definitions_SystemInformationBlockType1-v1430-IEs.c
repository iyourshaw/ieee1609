...
#include "EUTRA-RRC-Definitions_SystemInformationBlockType1-v1430-IEs.h"

#include "EUTRA-RRC-Definitions_TDD-Config-v1430.h"
#include "EUTRA-RRC-Definitions_SystemInformationBlockType1-v1450-IEs.h"
...
asn_TYPE_descriptor_t asn_DEF_eCallOverIMS_Support_r14_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_eCallOverIMS_Support_r14_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_cellAccessRelatedInfoList_r14_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs__cellAccessRelatedInfoList_r14),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs__cellAccessRelatedInfoList_r14, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_cellAccessRelatedInfoList_r14_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cellAccessRelatedInfoList_r14_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_1[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs, eCallOverIMS_Support_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs, tdd_Config_v1430),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs, cellAccessRelatedInfoList_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_cellAccessRelatedInfoList_r14_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs = {
	"SystemInformationBlockType1-v1430-IEs",
	"SystemInformationBlockType1-v1430-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType1_v1430_IEs_specs_1	/* Additional specs */
};
