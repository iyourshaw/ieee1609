...
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_RLC_Config_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_RLC_Config_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_am_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__am, ul_AM_RLC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__am, dl_AM_RLC),
...
static asn_SEQUENCE_specifics_t asn_SPC_am_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_RLC_Config__am),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config__am, _asn_ctx),
	asn_MAP_am_tag2el_2,
...
static asn_TYPE_member_t asn_MBR_um_Bi_Directional_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Bi_Directional, ul_UM_RLC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Bi_Directional, dl_UM_RLC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_um_Bi_Directional_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_RLC_Config__um_Bi_Directional),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Bi_Directional, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_um_Uni_Directional_UL_8[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_UL, ul_UM_RLC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_UL_UM_RLC,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_um_Uni_Directional_UL_specs_8 = {
	sizeof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_UL),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_UL, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_um_Uni_Directional_DL_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_DL, dl_UM_RLC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_DL_UM_RLC,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_um_Uni_Directional_DL_specs_10 = {
	sizeof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_DL),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config__um_Uni_Directional_DL, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RLC_Config_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config, choice.am),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_am_2,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config, choice.um_Bi_Directional),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config, choice.um_Uni_Directional_UL),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RLC_Config, choice.um_Uni_Directional_DL),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RLC_Config_tag2el_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RLC_Config_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RLC_Config),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_RLC_Config, present),
	sizeof(((struct EUTRA_RRC_Definitions_RLC_Config *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_RLC_Config_tag2el_1,
	4,	/* Count of tags in the map */
	0, 0,
	4	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RLC_Config = {
	"RLC-Config",
	"RLC-Config",
	&asn_OP_CHOICE,
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_RLC_Config_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_RLC_Config_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_RLC_Config_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RLC_Config_specs_1	/* Additional specs */
};
