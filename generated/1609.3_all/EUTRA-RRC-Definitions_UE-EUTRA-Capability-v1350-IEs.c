...
#include "EUTRA-RRC-Definitions_UE-EUTRA-Capability-v1350-IEs.h"

#include "EUTRA-RRC-Definitions_UE-EUTRA-Capability-v1360-IEs.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_ue_CategoryDL_v1350_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ue_CategoryDL_v1350_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_ue_CategoryUL_v1350_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ue_CategoryUL_v1350_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs, ue_CategoryDL_v1350),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs, ue_CategoryUL_v1350),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs, ce_Parameters_v1350),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs),
	offsetof(struct EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs = {
	"UE-EUTRA-Capability-v1350-IEs",
	"UE-EUTRA-Capability-v1350-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UE_EUTRA_Capability_v1350_IEs_specs_1	/* Additional specs */
};
