...
asn_TYPE_descriptor_t asn_DEF_drx_RetransmissionTimer_v1130_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_drx_RetransmissionTimer_v1130_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_longDRX_CycleStartOffset_v1130_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130, choice.sf60_v1130),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sf60_v1130_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130, choice.sf70_v1130),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sf70_v1130_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_CHOICE_specifics_t asn_SPC_longDRX_CycleStartOffset_v1130_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130),
	offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130, present),
	sizeof(((struct EUTRA_RRC_Definitions_DRX_Config_v1130__longDRX_CycleStartOffset_v1130 *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_longDRX_CycleStartOffset_v1130_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_longDRX_CycleStartOffset_v1130_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_shortDRX_Cycle_v1130_7 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_shortDRX_Cycle_v1130_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_DRX_Config_v1130_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130, drx_RetransmissionTimer_v1130),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130, longDRX_CycleStartOffset_v1130),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130, shortDRX_Cycle_v1130),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_DRX_Config_v1130_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_DRX_Config_v1130_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_DRX_Config_v1130_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_DRX_Config_v1130),
	offsetof(struct EUTRA_RRC_Definitions_DRX_Config_v1130, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_DRX_Config_v1130_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_DRX_Config_v1130_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130 = {
	"DRX-Config-v1130",
	"DRX-Config-v1130",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_DRX_Config_v1130_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_DRX_Config_v1130_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_DRX_Config_v1130_specs_1	/* Additional specs */
};
