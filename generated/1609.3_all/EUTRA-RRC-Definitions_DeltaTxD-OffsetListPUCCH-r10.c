...
asn_TYPE_descriptor_t asn_DEF_deltaTxD_OffsetPUCCH_Format1_r10_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaTxD_OffsetPUCCH_Format1_r10_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaTxD_OffsetPUCCH_Format1a1b_r10_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaTxD_OffsetPUCCH_Format1a1b_r10_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaTxD_OffsetPUCCH_Format22a2b_r10_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaTxD_OffsetPUCCH_Format22a2b_r10_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaTxD_OffsetPUCCH_Format3_r10_11 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaTxD_OffsetPUCCH_Format3_r10_constr_11,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10, deltaTxD_OffsetPUCCH_Format1_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10, deltaTxD_OffsetPUCCH_Format1a1b_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10, deltaTxD_OffsetPUCCH_Format22a2b_r10),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10, deltaTxD_OffsetPUCCH_Format3_r10),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10),
	offsetof(struct EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tag2el_1,
	4,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10 = {
	"DeltaTxD-OffsetListPUCCH-r10",
	"DeltaTxD-OffsetListPUCCH-r10",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_DeltaTxD_OffsetListPUCCH_r10_specs_1	/* Additional specs */
};
