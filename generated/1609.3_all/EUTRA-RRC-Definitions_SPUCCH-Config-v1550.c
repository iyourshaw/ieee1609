...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_n3SPUCCH_AN_List_v1550_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_n3SPUCCH_AN_List_v1550_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..4)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_constr_1 CC_NOTUSED = {
...
static asn_SET_OF_specifics_t asn_SPC_n3SPUCCH_AN_List_v1550_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup__twoAntennaPortActivatedSPUCCH_Format3_v1550__n3SPUCCH_AN_List_v1550),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup__twoAntennaPortActivatedSPUCCH_Format3_v1550__n3SPUCCH_AN_List_v1550, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_n3SPUCCH_AN_List_v1550_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_n3SPUCCH_AN_List_v1550_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_twoAntennaPortActivatedSPUCCH_Format3_v1550_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup__twoAntennaPortActivatedSPUCCH_Format3_v1550, n3SPUCCH_AN_List_v1550),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_n3SPUCCH_AN_List_v1550_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_twoAntennaPortActivatedSPUCCH_Format3_v1550_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup__twoAntennaPortActivatedSPUCCH_Format3_v1550),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup__twoAntennaPortActivatedSPUCCH_Format3_v1550, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_setup_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup, twoAntennaPortActivatedSPUCCH_Format3_v1550),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_setup_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550__setup, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550, choice.release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_setup_3,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550, present),
	sizeof(((struct EUTRA_RRC_Definitions_SPUCCH_Config_v1550 *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SPUCCH_Config_v1550 = {
	"SPUCCH-Config-v1550",
	"SPUCCH-Config-v1550",
	&asn_OP_CHOICE,
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SPUCCH_Config_v1550_specs_1	/* Additional specs */
};
