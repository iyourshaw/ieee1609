...
#include "EUTRA-RRC-Definitions_OverheatingAssistance-r14.h"
...
static asn_TYPE_member_t asn_MBR_reducedUE_Category_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedUE_Category, reducedUE_CategoryDL),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_reducedUE_CategoryDL_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedUE_Category, reducedUE_CategoryUL),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_reducedUE_CategoryUL_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_reducedUE_Category_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedUE_Category),
	offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedUE_Category, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_reducedMaxCCs_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedMaxCCs, reducedCCsDL),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_reducedCCsDL_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedMaxCCs, reducedCCsUL),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_reducedCCsUL_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_reducedMaxCCs_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedMaxCCs),
	offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14__reducedMaxCCs, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_OverheatingAssistance_r14_1[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14, reducedUE_Category),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14, reducedMaxCCs),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_OverheatingAssistance_r14_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* reducedUE-Category */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* reducedMaxCCs */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_OverheatingAssistance_r14_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14),
	offsetof(struct EUTRA_RRC_Definitions_OverheatingAssistance_r14, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_OverheatingAssistance_r14_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14 = {
	"OverheatingAssistance-r14",
	"OverheatingAssistance-r14",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_OverheatingAssistance_r14_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_OverheatingAssistance_r14_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_OverheatingAssistance_r14_specs_1	/* Additional specs */
};
