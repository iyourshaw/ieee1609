...
#include "EUTRA-Sidelink-Preconf_SL-PreconfigDiscPool-r13.h"
...
asn_TYPE_descriptor_t asn_DEF_discPeriod_r13_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_discPeriod_r13_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_txProbability_r13_25 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_txProbability_r13_constr_25,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_txParameters_r13_23[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13__txParameters_r13, txParametersGeneral_r13),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13__txParameters_r13, txProbability_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_txParameters_r13_specs_23 = {
	sizeof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13__txParameters_r13),
	offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13__txParameters_r13, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, cp_Len_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, discPeriod_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, numRetx_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_numRetx_r13_constr_20,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, numRepetition_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_numRepetition_r13_constr_21,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, tf_ResourceConfig_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, txParameters_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
...
static const int asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_oms_1[] = { 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_specs_1 = {
	sizeof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13),
	offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13, _asn_ctx),
	asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13 = {
	"SL-PreconfigDiscPool-r13",
	"SL-PreconfigDiscPool-r13",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1,
	sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_Sidelink_Preconf_SL_PreconfigDiscPool_r13_specs_1	/* Additional specs */
};
