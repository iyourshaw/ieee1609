...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format3_r12_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaF_PUCCH_Format3_r12_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format1bCS_r12_13 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaF_PUCCH_Format1bCS_r12_constr_13,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format4_r13_18 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaF_PUCCH_Format4_r13_constr_18,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deltaF_PUCCH_Format5_13_27 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deltaF_PUCCH_Format5_13_constr_27,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, p0_NominalPUCCH),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_p0_NominalPUCCH_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, deltaFList_PUCCH),
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, deltaF_PUCCH_Format3_r12),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, deltaF_PUCCH_Format1bCS_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, deltaF_PUCCH_Format4_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, deltaF_PUCCH_Format5_13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_oms_1[] = { 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310),
	offsetof(struct EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310 = {
	"UplinkPowerControlCommonSCell-v1310",
	"UplinkPowerControlCommonSCell-v1310",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UplinkPowerControlCommonSCell_v1310_specs_1	/* Additional specs */
};
