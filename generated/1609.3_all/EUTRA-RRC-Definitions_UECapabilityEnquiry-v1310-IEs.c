...
#include "EUTRA-RRC-Definitions_UECapabilityEnquiry-v1310-IEs.h"

#include "EUTRA-RRC-Definitions_UECapabilityEnquiry-v1430-IEs.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_requestReducedFormat_r13_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_requestReducedFormat_r13_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_requestSkipFallbackComb_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_requestSkipFallbackComb_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_requestReducedIntNonContComb_r13_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_requestReducedIntNonContComb_r13_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_1[] = {
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, requestReducedFormat_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, requestSkipFallbackComb_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, requestedMaxCCsDL_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_requestedMaxCCsDL_r13_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, requestedMaxCCsUL_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_requestedMaxCCsUL_r13_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, requestReducedIntNonContComb_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs),
	offsetof(struct EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_oms_1,	/* Optional members */
	6, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs = {
	"UECapabilityEnquiry-v1310-IEs",
	"UECapabilityEnquiry-v1310-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UECapabilityEnquiry_v1310_IEs_specs_1	/* Additional specs */
};
