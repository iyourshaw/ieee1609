...
asn_TYPE_descriptor_t asn_DEF_modificationPeriodCoeff_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_modificationPeriodCoeff_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_BCCH_Config_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_BCCH_Config, modificationPeriodCoeff),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_BCCH_Config_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* modificationPeriodCoeff */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_BCCH_Config_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_BCCH_Config),
	offsetof(struct EUTRA_RRC_Definitions_BCCH_Config, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_BCCH_Config_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_BCCH_Config = {
	"BCCH-Config",
	"BCCH-Config",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_BCCH_Config_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_BCCH_Config_1,
	1,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_BCCH_Config_specs_1	/* Additional specs */
};
