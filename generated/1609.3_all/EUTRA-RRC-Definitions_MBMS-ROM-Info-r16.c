...
static asn_oer_constraints_t asn_OER_type_mbms_ROM_SubcarrierSpacing_r16_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_mbms_Bandwidth_r16_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_mbms_ROM_SubcarrierSpacing_r16_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mbms_ROM_SubcarrierSpacing_r16_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_mbms_Bandwidth_r16_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mbms_Bandwidth_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_ROM_Info_r16, mbms_ROM_Freq_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_ROM_Info_r16, mbms_ROM_SubcarrierSpacing_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_ROM_Info_r16, mbms_Bandwidth_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MBMS_ROM_Info_r16),
	offsetof(struct EUTRA_RRC_Definitions_MBMS_ROM_Info_r16, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16 = {
	"MBMS-ROM-Info-r16",
	"MBMS-ROM-Info-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MBMS_ROM_Info_r16_specs_1	/* Additional specs */
};
