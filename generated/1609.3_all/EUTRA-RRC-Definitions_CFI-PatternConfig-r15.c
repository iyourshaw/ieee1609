...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_cfi_PatternSubframe_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_cfi_PatternSlotSubslot_r15_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_cfi_PatternSubframe_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_cfi_PatternSlotSubslot_r15_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_cfi_PatternSubframe_r15_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15__cfi_PatternSubframe_r15),
	offsetof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15__cfi_PatternSubframe_r15, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_cfi_PatternSubframe_r15_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cfi_PatternSubframe_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_cfi_PatternSlotSubslot_r15_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15__cfi_PatternSlotSubslot_r15),
	offsetof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15__cfi_PatternSlotSubslot_r15, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cfi_PatternSlotSubslot_r15_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cfi_PatternSlotSubslot_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_1[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15, cfi_PatternSubframe_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_cfi_PatternSubframe_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15, cfi_PatternSlotSubslot_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_cfi_PatternSlotSubslot_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const int asn_MAP_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cfi-PatternSubframe-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cfi-PatternSlotSubslot-r15 */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15),
	offsetof(struct EUTRA_RRC_Definitions_CFI_PatternConfig_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15 = {
	"CFI-PatternConfig-r15",
	"CFI-PatternConfig-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_CFI_PatternConfig_r15_specs_1	/* Additional specs */
};
