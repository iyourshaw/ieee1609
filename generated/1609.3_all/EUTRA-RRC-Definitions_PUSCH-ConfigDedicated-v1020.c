...
static asn_TYPE_member_t asn_MBR_betaOffsetMC_r10_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_ACK_Index_MC_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_betaOffset_ACK_Index_MC_r10_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_RI_Index_MC_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_betaOffset_RI_Index_MC_r10_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, betaOffset_CQI_Index_MC_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_betaOffset_CQI_Index_MC_r10_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_betaOffsetMC_r10_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10),
	offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020__betaOffsetMC_r10, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_groupHoppingDisabled_r10_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_groupHoppingDisabled_r10_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_dmrs_WithOCC_Activated_r10_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_dmrs_WithOCC_Activated_r10_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020, betaOffsetMC_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020, groupHoppingDisabled_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020, dmrs_WithOCC_Activated_r10),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020),
	offsetof(struct EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020 = {
	"PUSCH-ConfigDedicated-v1020",
	"PUSCH-ConfigDedicated-v1020",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PUSCH_ConfigDedicated_v1020_specs_1	/* Additional specs */
};
