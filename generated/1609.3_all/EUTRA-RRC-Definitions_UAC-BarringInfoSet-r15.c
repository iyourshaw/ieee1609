...
#include "EUTRA-RRC-Definitions_UAC-BarringInfoSet-r15.h"
...
asn_TYPE_descriptor_t asn_DEF_uac_BarringFactor_r15_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_uac_BarringFactor_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_uac_BarringTime_r15_19 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_uac_BarringTime_r15_constr_19,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15, uac_BarringFactor_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15, uac_BarringTime_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15, uac_BarringForAccessIdentity_r15),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_uac_BarringForAccessIdentity_r15_constr_28,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15),
	offsetof(struct EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15 = {
	"UAC-BarringInfoSet-r15",
	"UAC-BarringInfoSet-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_UAC_BarringInfoSet_r15_specs_1	/* Additional specs */
};
