...
#include "EUTRA-RRC-Definitions_NAICS-Capability-Entry-r12.h"
...
asn_TYPE_descriptor_t asn_DEF_numberOfAggregatedPRB_r12_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_numberOfAggregatedPRB_r12_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12, numberOfNAICS_CapableCC_r12),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_numberOfNAICS_CapableCC_r12_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12, numberOfAggregatedPRB_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* numberOfNAICS-CapableCC-r12 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* numberOfAggregatedPRB-r12 */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12),
	offsetof(struct EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12 = {
	"NAICS-Capability-Entry-r12",
	"NAICS-Capability-Entry-r12",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_NAICS_Capability_Entry_r12_specs_1	/* Additional specs */
};
