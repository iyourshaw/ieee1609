...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_mch_SchedulingPeriod_v1430_constr_18 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_dataMCS_r12_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12, choice.normal_r12),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_normal_r12_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12, choice.higerOrder_r12),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_higerOrder_r12_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_CHOICE_specifics_t asn_SPC_dataMCS_r12_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12),
	offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12, present),
	sizeof(((struct EUTRA_RRC_Definitions_PMCH_Config_r12__dataMCS_r12 *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_dataMCS_r12_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_dataMCS_r12_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_r12_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mch_SchedulingPeriod_r12_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_mch_SchedulingPeriod_v1430_18 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mch_SchedulingPeriod_v1430_constr_18,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext1_17[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__ext1, mch_SchedulingPeriod_v1430),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_17 = {
	sizeof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__ext1),
	offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PMCH_Config_r12_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12, sf_AllocEnd_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_sf_AllocEnd_r12_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12, dataMCS_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12, mch_SchedulingPeriod_r12),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_17,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_PMCH_Config_r12_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PMCH_Config_r12_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PMCH_Config_r12_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PMCH_Config_r12),
	offsetof(struct EUTRA_RRC_Definitions_PMCH_Config_r12, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PMCH_Config_r12_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PMCH_Config_r12_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
	3,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12 = {
	"PMCH-Config-r12",
	"PMCH-Config-r12",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PMCH_Config_r12_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PMCH_Config_r12_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PMCH_Config_r12_specs_1	/* Additional specs */
};
