...
asn_TYPE_descriptor_t asn_DEF_srs_BandwidthAp_r10_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_srs_BandwidthAp_r10_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cyclicShiftAp_r10_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cyclicShiftAp_r10_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, srs_AntennaPortAp_r10),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, srs_BandwidthAp_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, freqDomainPositionAp_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_freqDomainPositionAp_r10_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, transmissionCombAp_r10),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_transmissionCombAp_r10_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, cyclicShiftAp_r10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10),
	offsetof(struct EUTRA_RRC_Definitions_SRS_ConfigAp_r10, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tag2el_1,
	5,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10 = {
	"SRS-ConfigAp-r10",
	"SRS-ConfigAp-r10",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_1,
	5,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SRS_ConfigAp_r10_specs_1	/* Additional specs */
};
