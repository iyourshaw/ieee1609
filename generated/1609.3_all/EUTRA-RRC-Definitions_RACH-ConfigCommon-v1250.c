...
asn_TYPE_descriptor_t asn_DEF_connEstFailCount_r12_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_connEstFailCount_r12_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_connEstFailOffsetValidity_r12_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_connEstFailOffsetValidity_r12_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_txFailParams_r12_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250__txFailParams_r12, connEstFailCount_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250__txFailParams_r12, connEstFailOffsetValidity_r12),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250__txFailParams_r12, connEstFailOffset_r12),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_connEstFailOffset_r12_constr_17,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_txFailParams_r12_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250__txFailParams_r12),
	offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250__txFailParams_r12, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250, txFailParams_r12),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* txFailParams-r12 */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250),
	offsetof(struct EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250 = {
	"RACH-ConfigCommon-v1250",
	"RACH-ConfigCommon-v1250",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_1,
	1,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RACH_ConfigCommon_v1250_specs_1	/* Additional specs */
};
