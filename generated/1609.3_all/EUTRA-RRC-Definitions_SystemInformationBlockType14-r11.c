...
#include "EUTRA-RRC-Definitions_EAB-ConfigPLMN-r11.h"
static int
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_eab_PerRSRP_r15_constr_9 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_eab_PerPLMN_List_r11_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11__eab_PerPLMN_List_r11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11__eab_PerPLMN_List_r11, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_eab_PerPLMN_List_r11_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_eab_PerPLMN_List_r11_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_eab_Param_r11_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11, choice.eab_Common_r11),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11, choice.eab_PerPLMN_List_r11),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_eab_PerPLMN_List_r11_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_CHOICE_specifics_t asn_SPC_eab_Param_r11_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11, present),
	sizeof(((struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__eab_Param_r11 *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_eab_Param_r11_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_eab_Param_r11_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_eab_PerRSRP_r15_9 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_eab_PerRSRP_r15_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext1_8[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__ext1, eab_PerRSRP_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_8 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__ext1),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11, eab_Param_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType14_r11, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_oms_1,	/* Optional members */
	2, 1,	/* Root/Additions */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11 = {
	"SystemInformationBlockType14-r11",
	"SystemInformationBlockType14-r11",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType14_r11_specs_1	/* Additional specs */
};
