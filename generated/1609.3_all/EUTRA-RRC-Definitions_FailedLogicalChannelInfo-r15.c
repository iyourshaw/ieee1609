...
#include "EUTRA-RRC-Definitions_FailedLogicalChannelInfo-r15.h"
...
static asn_oer_constraints_t asn_OER_type_cellGroupIndication_r15_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_failureType_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cellGroupIndication_r15_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cellGroupIndication_r15_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_failedLogicalChannelIdentity_r15_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15__failedLogicalChannelIdentity_r15, cellGroupIndication_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15__failedLogicalChannelIdentity_r15, logicalChannelIdentity_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15__failedLogicalChannelIdentity_r15, logicalChannelIdentityExt_r15),
...
static asn_SEQUENCE_specifics_t asn_SPC_failedLogicalChannelIdentity_r15_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15__failedLogicalChannelIdentity_r15),
	offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15__failedLogicalChannelIdentity_r15, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_failureType_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_failureType_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15, failedLogicalChannelIdentity_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15, failureType),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* failedLogicalChannelIdentity-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* failureType */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15),
	offsetof(struct EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15 = {
	"FailedLogicalChannelInfo-r15",
	"FailedLogicalChannelInfo-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_FailedLogicalChannelInfo_r15_specs_1	/* Additional specs */
};
