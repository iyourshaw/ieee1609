...
asn_TYPE_descriptor_t asn_DEF_shortSPS_IntervalFDD_r14_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_shortSPS_IntervalFDD_r14_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_shortSPS_IntervalTDD_r14_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_shortSPS_IntervalTDD_r14_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipUplinkDynamic_r14_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipUplinkDynamic_r14_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipUplinkSPS_r14_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipUplinkSPS_r14_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_multipleUplinkSPS_r14_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_multipleUplinkSPS_r14_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_dataInactMon_r14_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_dataInactMon_r14_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MAC_Parameters_v1430_1[] = {
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, shortSPS_IntervalFDD_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, shortSPS_IntervalTDD_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, skipUplinkDynamic_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, skipUplinkSPS_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, multipleUplinkSPS_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, dataInactMon_r14),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_MAC_Parameters_v1430_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MAC_Parameters_v1430_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430),
	offsetof(struct EUTRA_RRC_Definitions_MAC_Parameters_v1430, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tag2el_1,
	6,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_MAC_Parameters_v1430_oms_1,	/* Optional members */
	6, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430 = {
	"MAC-Parameters-v1430",
	"MAC-Parameters-v1430",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MAC_Parameters_v1430_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MAC_Parameters_v1430_1,
	6,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MAC_Parameters_v1430_specs_1	/* Additional specs */
};
