...
asn_TYPE_descriptor_t asn_DEF_notificationRepetitionCoeff_r9_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_notificationRepetitionCoeff_r9_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9, notificationRepetitionCoeff_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9, notificationOffset_r9),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_notificationOffset_r9_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9, notificationSF_Index_r9),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_notificationSF_Index_r9_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9),
	offsetof(struct EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9 = {
	"MBMS-NotificationConfig-r9",
	"MBMS-NotificationConfig-r9",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MBMS_NotificationConfig_r9_specs_1	/* Additional specs */
};
