...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_slss_TxDisabled_r15_constr_21 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_syncRefMinHyst_r14_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_syncRefMinHyst_r14_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_syncRefDiffHyst_r14_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_syncRefDiffHyst_r14_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_slss_TxDisabled_r15_21 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_slss_TxDisabled_r15_constr_21,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext1_20[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14__ext1, slss_TxDisabled_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_20 = {
	sizeof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14__ext1),
	offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, syncOffsetIndicators_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, syncTxParameters_r14),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, syncTxThreshOoC_r14),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, filterCoefficient_r14),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, syncRefMinHyst_r14),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, syncRefDiffHyst_r14),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_20,
		0,
...
static const int asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_oms_1[] = { 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_specs_1 = {
	sizeof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14),
	offsetof(struct EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14, _asn_ctx),
	asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14 = {
	"SL-PreconfigV2X-Sync-r14",
	"SL-PreconfigV2X-Sync-r14",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1,
	sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_Sidelink_Preconf_SL_PreconfigV2X_Sync_r14_specs_1	/* Additional specs */
};
