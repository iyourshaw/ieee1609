...
#include "EUTRA-RRC-Definitions_RRCConnectionReject-v1130-IEs.h"

#include "EUTRA-RRC-Definitions_RRCConnectionReject-v1320-IEs.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_deprioritisationType_r11_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deprioritisationType_r11_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_deprioritisationTimer_r11_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_deprioritisationTimer_r11_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_deprioritisationReq_r11_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs__deprioritisationReq_r11, deprioritisationType_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs__deprioritisationReq_r11, deprioritisationTimer_r11),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_deprioritisationReq_r11_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs__deprioritisationReq_r11),
	offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs__deprioritisationReq_r11, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs, deprioritisationReq_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* deprioritisationReq-r11 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs),
	offsetof(struct EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs = {
	"RRCConnectionReject-v1130-IEs",
	"RRCConnectionReject-v1130-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RRCConnectionReject_v1130_IEs_specs_1	/* Additional specs */
};
