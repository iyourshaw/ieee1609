...
asn_TYPE_descriptor_t asn_DEF_rmtc_PeriodicityNR_r16_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rmtc_PeriodicityNR_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_measDurationNR_r16_9 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_measDurationNR_r16_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_refSCS_CP_NR_r16_16 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_refSCS_CP_NR_r16_constr_16,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, rmtc_PeriodicityNR_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, rmtc_SubframeOffsetNR_r16),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_rmtc_SubframeOffsetNR_r16_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, measDurationNR_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, rmtc_FrequencyNR_r16),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, refSCS_CP_NR_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16),
	offsetof(struct EUTRA_RRC_Definitions_RMTC_ConfigNR_r16, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	5,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16 = {
	"RMTC-ConfigNR-r16",
	"RMTC-ConfigNR-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_1,
	5,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RMTC_ConfigNR_r16_specs_1	/* Additional specs */
};
