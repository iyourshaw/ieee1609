...
static asn_oer_constraints_t asn_OER_type_pdcp_VersionChangeWithoutHO_r16_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_ehc_r16_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_continueEHC_Context_r16_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_maxNumberEHC_Contexts_r16_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_jointEHC_ROHC_Config_r16_constr_25 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_pdcp_VersionChangeWithoutHO_r16_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_pdcp_VersionChangeWithoutHO_r16_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_continueEHC_Context_r16_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_continueEHC_Context_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_maxNumberEHC_Contexts_r16_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_maxNumberEHC_Contexts_r16_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_jointEHC_ROHC_Config_r16_25 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_jointEHC_ROHC_Config_r16_constr_25,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_1[] = {
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, pdcp_VersionChangeWithoutHO_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, ehc_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ehc_r16_4,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, continueEHC_Context_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, maxNumberEHC_Contexts_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, jointEHC_ROHC_Config_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_oms_1[] = { 0, 1, 2, 3, 4 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610),
	offsetof(struct EUTRA_RRC_Definitions_PDCP_Parameters_v1610, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tag2el_1,
	5,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610 = {
	"PDCP-Parameters-v1610",
	"PDCP-Parameters-v1610",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_1,
	5,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PDCP_Parameters_v1610_specs_1	/* Additional specs */
};
