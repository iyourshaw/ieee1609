...
#include "EUTRA-RRC-Definitions_PRACH-ParametersCE-r13.h"
...
asn_TYPE_descriptor_t asn_DEF_prach_StartingSubframe_r13_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_prach_StartingSubframe_r13_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_maxNumPreambleAttemptCE_r13_13 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_maxNumPreambleAttemptCE_r13_constr_13,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_numRepetitionPerPreambleAttempt_r13_21 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_numRepetitionPerPreambleAttempt_r13_constr_21,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_mpdcch_NarrowbandsToMonitor_r13_specs_30 = {
	sizeof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13__mpdcch_NarrowbandsToMonitor_r13),
	offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13__mpdcch_NarrowbandsToMonitor_r13, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_mpdcch_NarrowbandsToMonitor_r13_30 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mpdcch_NarrowbandsToMonitor_r13_constr_30,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_mpdcch_NumRepetition_RA_r13_32 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_mpdcch_NumRepetition_RA_r13_constr_32,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_prach_HoppingConfig_r13_42 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_prach_HoppingConfig_r13_constr_42,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, prach_ConfigIndex_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_prach_ConfigIndex_r13_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, prach_FreqOffset_r13),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_prach_FreqOffset_r13_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, prach_StartingSubframe_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, maxNumPreambleAttemptCE_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, numRepetitionPerPreambleAttempt_r13),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, mpdcch_NarrowbandsToMonitor_r13),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_mpdcch_NarrowbandsToMonitor_r13_constr_30,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, mpdcch_NumRepetition_RA_r13),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, prach_HoppingConfig_r13),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_oms_1[] = { 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13),
	offsetof(struct EUTRA_RRC_Definitions_PRACH_ParametersCE_r13, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13 = {
	"PRACH-ParametersCE-r13",
	"PRACH-ParametersCE-r13",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_1,
	8,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PRACH_ParametersCE_r13_specs_1	/* Additional specs */
};
