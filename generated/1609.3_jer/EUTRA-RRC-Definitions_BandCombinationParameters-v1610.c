...
#include "EUTRA-RRC-Definitions_BandCombinationParameters-v1610.h"
...
static asn_SET_OF_specifics_t asn_SPC_bandParameterList_v1610_specs_3 = {
	sizeof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__bandParameterList_v1610),
	offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__bandParameterList_v1610, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_bandParameterList_v1610_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_bandParameterList_v1610_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_interFreqAsyncDAPS_r16_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_interFreqAsyncDAPS_r16_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_interFreqMultiUL_TransmissionDAPS_r16_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_interFreqMultiUL_TransmissionDAPS_r16_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_interFreqDAPS_r16_5[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__interFreqDAPS_r16, interFreqAsyncDAPS_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__interFreqDAPS_r16, interFreqMultiUL_TransmissionDAPS_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_interFreqDAPS_r16_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__interFreqDAPS_r16),
	offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610__interFreqDAPS_r16, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610, measGapInfoNR),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610, bandParameterList_v1610),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_bandParameterList_v1610_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610, interFreqDAPS_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measGapInfoNR */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* bandParameterList-v1610 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* interFreqDAPS-r16 */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610),
	offsetof(struct EUTRA_RRC_Definitions_BandCombinationParameters_v1610, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610 = {
	"BandCombinationParameters-v1610",
	"BandCombinationParameters-v1610",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_BandCombinationParameters_v1610_specs_1	/* Additional specs */
};
