...
asn_TYPE_descriptor_t asn_DEF_rf_RetuningTimeDL_r14_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rf_RetuningTimeDL_r14_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_rf_RetuningTimeUL_r14_20 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_rf_RetuningTimeUL_r14_constr_20,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_retuningInfo_2[] = {
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14__retuningInfo, rf_RetuningTimeDL_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14__retuningInfo, rf_RetuningTimeUL_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_retuningInfo_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14__retuningInfo),
	offsetof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14__retuningInfo, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14, retuningInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* retuningInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14),
	offsetof(struct EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14 = {
	"SRS-CapabilityPerBandPair-r14",
	"SRS-CapabilityPerBandPair-r14",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_1,
	1,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SRS_CapabilityPerBandPair_r14_specs_1	/* Additional specs */
};
