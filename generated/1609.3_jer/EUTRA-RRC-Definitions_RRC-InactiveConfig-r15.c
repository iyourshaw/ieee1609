...
#include "EUTRA-RRC-Definitions_RAN-NotificationAreaInfo-r15.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_ran_PagingCycle_r15_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_ran_PagingCycle_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_periodic_RNAU_timer_r15_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_periodic_RNAU_timer_r15_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_dummy_specs_20 = {
	sizeof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15__dummy),
	offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15__dummy, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, fullI_RNTI_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, shortI_RNTI_r15),
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, ran_PagingCycle_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, ran_NotificationAreaInfo_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, periodic_RNAU_timer_r15),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, nextHopChainingCount_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, dummy),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_dummy_20,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_oms_1[] = { 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15),
	offsetof(struct EUTRA_RRC_Definitions_RRC_InactiveConfig_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_oms_1,	/* Optional members */
	5, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15 = {
	"RRC-InactiveConfig-r15",
	"RRC-InactiveConfig-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_RRC_InactiveConfig_r15_specs_1	/* Additional specs */
};
