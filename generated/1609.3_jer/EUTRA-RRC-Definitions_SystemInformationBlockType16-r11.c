...
static asn_TYPE_member_t asn_MBR_timeInfo_r11_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11, timeInfoUTC_r11),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_timeInfoUTC_r11_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11, dayLightSavingTime_r11),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_dayLightSavingTime_r11_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11, leapSeconds_r11),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_leapSeconds_r11_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11, localTimeOffset_r11),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_localTimeOffset_r11_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_timeInfo_r11_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__timeInfo_r11, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext1_9[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__ext1, timeReferenceInfo_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_9 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__ext1),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_1[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11, timeInfo_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType16_r11, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_oms_1,	/* Optional members */
	2, 1,	/* Root/Additions */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11 = {
	"SystemInformationBlockType16-r11",
	"SystemInformationBlockType16-r11",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType16_r11_specs_1	/* Additional specs */
};
