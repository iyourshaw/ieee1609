...
#include "EUTRA-RRC-Definitions_MRDC-AssistanceInfo-r15.h"

#include "EUTRA-RRC-Definitions_AffectedCarrierFreqCombInfoMRDC-r15.h"
#include "EUTRA-RRC-Definitions_VictimSystemType-v1610.h"
static int
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_affectedCarrierFreqCombInfoListMRDC_v1610_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_memb_affectedCarrierFreqCombInfoListMRDC_v1610_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..128)) */};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_affectedCarrierFreqCombInfoListMRDC_r15_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__affectedCarrierFreqCombInfoListMRDC_r15),
	offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__affectedCarrierFreqCombInfoListMRDC_r15, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_affectedCarrierFreqCombInfoListMRDC_r15_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_affectedCarrierFreqCombInfoListMRDC_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SET_OF_specifics_t asn_SPC_affectedCarrierFreqCombInfoListMRDC_v1610_specs_6 = {
	sizeof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__ext1__affectedCarrierFreqCombInfoListMRDC_v1610),
	offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__ext1__affectedCarrierFreqCombInfoListMRDC_v1610, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_affectedCarrierFreqCombInfoListMRDC_v1610_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_affectedCarrierFreqCombInfoListMRDC_v1610_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext1_5[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__ext1, affectedCarrierFreqCombInfoListMRDC_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_affectedCarrierFreqCombInfoListMRDC_v1610_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_5 = {
	sizeof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__ext1),
	offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15, affectedCarrierFreqCombInfoListMRDC_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_affectedCarrierFreqCombInfoListMRDC_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* affectedCarrierFreqCombInfoListMRDC-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ext1 */
};
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15),
	offsetof(struct EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
	1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15 = {
	"MRDC-AssistanceInfo-r15",
	"MRDC-AssistanceInfo-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_MRDC_AssistanceInfo_r15_specs_1	/* Additional specs */
};
