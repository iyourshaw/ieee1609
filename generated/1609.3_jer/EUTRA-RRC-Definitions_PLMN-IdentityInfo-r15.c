...
#include "EUTRA-RRC-Definitions_PLMN-IdentityInfo-r15.h"
...
static asn_oer_constraints_t asn_OER_memb_plmn_Index_r15_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_plmn_Identity_5GC_r15_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_cellReservedForOperatorUse_r15_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_cellReservedForOperatorUse_CRS_r15_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_plmn_Identity_5GC_r15_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15, choice.plmn_Identity_r15),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15, choice.plmn_Index_r15),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_plmn_Index_r15_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_CHOICE_specifics_t asn_SPC_plmn_Identity_5GC_r15_specs_2 = {
	sizeof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15),
	offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15, present),
	sizeof(((struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15__plmn_Identity_5GC_r15 *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_plmn_Identity_5GC_r15_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_plmn_Identity_5GC_r15_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cellReservedForOperatorUse_r15_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cellReservedForOperatorUse_r15_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_cellReservedForOperatorUse_CRS_r15_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_cellReservedForOperatorUse_CRS_r15_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15, plmn_Identity_5GC_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15, cellReservedForOperatorUse_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15, cellReservedForOperatorUse_CRS_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15),
	offsetof(struct EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15 = {
	"PLMN-IdentityInfo-r15",
	"PLMN-IdentityInfo-r15",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_1,
	3,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PLMN_IdentityInfo_r15_specs_1	/* Additional specs */
};
