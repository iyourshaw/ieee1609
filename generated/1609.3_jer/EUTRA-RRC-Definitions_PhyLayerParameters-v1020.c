...
#include "EUTRA-RRC-Definitions_NonContiguousUL-RA-WithinCC-List-r10.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_twoAntennaPortsForPUCCH_r10_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_twoAntennaPortsForPUCCH_r10_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_tm9_With_8Tx_FDD_r10_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_tm9_With_8Tx_FDD_r10_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_pmi_Disabling_r10_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_pmi_Disabling_r10_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_crossCarrierScheduling_r10_8 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_crossCarrierScheduling_r10_constr_8,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_simultaneousPUCCH_PUSCH_r10_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_simultaneousPUCCH_PUSCH_r10_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_multiClusterPUSCH_WithinCC_r10_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_multiClusterPUSCH_WithinCC_r10_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_1[] = {
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, twoAntennaPortsForPUCCH_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, tm9_With_8Tx_FDD_r10),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, pmi_Disabling_r10),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, crossCarrierScheduling_r10),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, simultaneousPUCCH_PUSCH_r10),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, multiClusterPUSCH_WithinCC_r10),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, nonContiguousUL_RA_WithinCC_List_r10),
...
static const int asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020),
	offsetof(struct EUTRA_RRC_Definitions_PhyLayerParameters_v1020, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_oms_1,	/* Optional members */
	7, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020 = {
	"PhyLayerParameters-v1020",
	"PhyLayerParameters-v1020",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PhyLayerParameters_v1020_specs_1	/* Additional specs */
};
