...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_EUTRA_RRC_Definitions_DelayBudgetReport_r14_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
asn_per_constraints_t asn_PER_type_EUTRA_RRC_Definitions_DelayBudgetReport_r14_constr_1 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_DelayBudgetReport_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DelayBudgetReport_r14, choice.type1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_DelayBudgetReport_r14, choice.type2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_type2_20,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_DelayBudgetReport_r14_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* type1 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* type2 */
};
asn_CHOICE_specifics_t asn_SPC_EUTRA_RRC_Definitions_DelayBudgetReport_r14_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_DelayBudgetReport_r14),
	offsetof(struct EUTRA_RRC_Definitions_DelayBudgetReport_r14, _asn_ctx),
	offsetof(struct EUTRA_RRC_Definitions_DelayBudgetReport_r14, present),
	sizeof(((struct EUTRA_RRC_Definitions_DelayBudgetReport_r14 *)0)->present),
	asn_MAP_EUTRA_RRC_Definitions_DelayBudgetReport_r14_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_DelayBudgetReport_r14 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_EUTRA_RRC_Definitions_DelayBudgetReport_r14_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_EUTRA_RRC_Definitions_DelayBudgetReport_r14_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
		CHOICE_constraint
	},
	asn_MBR_EUTRA_RRC_Definitions_DelayBudgetReport_r14_1,
	2,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_DelayBudgetReport_r14_specs_1	/* Additional specs */
};
