...
#include "EUTRA-RRC-Definitions_CSFB-RegistrationParam1XRTT.h"
#include "EUTRA-RRC-Definitions_CellReselectionParametersCDMA2000-v920.h"
#include "EUTRA-RRC-Definitions_CSFB-RegistrationParam1XRTT-v920.h"
#include "EUTRA-RRC-Definitions_AC-BarringConfig1XRTT-r9.h"
#include "EUTRA-RRC-Definitions_SIB8-PerPLMN-List-r11.h"
static int
...
#if !defined(ASN_DISABLE_OER_SUPPORT)
static asn_oer_constraints_t asn_OER_type_csfb_DualRxTxSupport_r10_constr_20 CC_NOTUSED = {
	{ 0, 0 },
	-1};
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_parametersHRPD_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parametersHRPD, preRegistrationInfoHRPD),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parametersHRPD, cellReselectionParametersHRPD),
...
static asn_SEQUENCE_specifics_t asn_SPC_parametersHRPD_specs_4 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parametersHRPD),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parametersHRPD, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_parameters1XRTT_7[] = {
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parameters1XRTT, csfb_RegistrationParam1XRTT),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parameters1XRTT, longCodeState1XRTT),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_longCodeState1XRTT_constr_9,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parameters1XRTT, cellReselectionParameters1XRTT),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_CellReselectionParametersCDMA2000,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_parameters1XRTT_specs_7 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parameters1XRTT),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__parameters1XRTT, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext1_13[] = {
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, csfb_SupportForDualRxUEs_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, cellReselectionParametersHRPD_v920),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, cellReselectionParameters1XRTT_v920),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_EUTRA_RRC_Definitions_CellReselectionParametersCDMA2000_v920,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, csfb_RegistrationParam1XRTT_v920),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, ac_BarringConfig1XRTT_r9),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_13 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext1, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_csfb_DualRxTxSupport_r10_20 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_csfb_DualRxTxSupport_r10_constr_20,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
static asn_TYPE_member_t asn_MBR_ext2_19[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext2, csfb_DualRxTxSupport_r10),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_19 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext2),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_ext3_22[] = {
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext3, sib8_PerPLMN_List_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_22 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext3),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType8_1[] = {
	{ ATF_POINTER, 8, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, systemTimeInfo),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, searchWindowSize),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_searchWindowSize_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, parametersHRPD),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, parameters1XRTT),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_13,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_19,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, ext3),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext3_22,
		0,
...
static const int asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType8_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType8_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType8_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType8, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType8_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType8_oms_1,	/* Optional members */
	4, 4,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8 = {
	"SystemInformationBlockType8",
	"SystemInformationBlockType8",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType8_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType8_1,
	8,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType8_specs_1	/* Additional specs */
};
