...
asn_TYPE_descriptor_t asn_DEF_warningMessageSegmentType_4 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_warningMessageSegmentType_constr_4,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType11_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, messageIdentifier),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_messageIdentifier_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, serialNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, warningMessageSegmentType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, warningMessageSegmentNumber),
		...
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			&asn_OER_memb_warningMessageSegmentNumber_constr_7,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, warningMessageSegment),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, dataCodingScheme),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, lateNonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType11_oms_1[] = { 5, 6 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType11_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType11_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11),
	offsetof(struct EUTRA_RRC_Definitions_SystemInformationBlockType11, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType11_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_SystemInformationBlockType11_oms_1,	/* Optional members */
	1, 1,	/* Root/Additions */
	6,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11 = {
	"SystemInformationBlockType11",
	"SystemInformationBlockType11",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_SystemInformationBlockType11_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_SystemInformationBlockType11_1,
	7,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_SystemInformationBlockType11_specs_1	/* Additional specs */
};
