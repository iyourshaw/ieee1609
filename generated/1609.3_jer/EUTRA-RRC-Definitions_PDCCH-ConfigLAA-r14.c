...
#include "EUTRA-RRC-Definitions_PDCCH-CandidateReductionsLAA-UL-r14.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_maxNumberOfSchedSubframes_Format0B_r14_2 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_maxNumberOfSchedSubframes_Format0B_r14_constr_2,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_maxNumberOfSchedSubframes_Format4B_r14_6 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_maxNumberOfSchedSubframes_Format4B_r14_constr_6,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipMonitoringDCI_Format0A_r14_10 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipMonitoringDCI_Format0A_r14_constr_10,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_skipMonitoringDCI_Format4A_r14_12 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_skipMonitoringDCI_Format4A_r14_constr_12,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_1[] = {
	{ ATF_POINTER, 8, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, maxNumberOfSchedSubframes_Format0B_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 7, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, maxNumberOfSchedSubframes_Format4B_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, skipMonitoringDCI_Format0A_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, skipMonitoringDCI_Format4A_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, pdcch_CandidateReductions_Format0A_r14),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, pdcch_CandidateReductions_Format4A_r14),
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, pdcch_CandidateReductions_Format0B_r14),
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, pdcch_CandidateReductions_Format4B_r14),
...
static const int asn_MAP_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14),
	offsetof(struct EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tag2el_1,
	8,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_oms_1,	/* Optional members */
	8, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14 = {
	"PDCCH-ConfigLAA-r14",
	"PDCCH-ConfigLAA-r14",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_1,
	8,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_PDCCH_ConfigLAA_r14_specs_1	/* Additional specs */
};
