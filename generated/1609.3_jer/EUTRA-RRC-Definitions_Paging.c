...
#include "EUTRA-RRC-Definitions_PagingRecordList.h"
#include "EUTRA-RRC-Definitions_Paging-v890-IEs.h"
/*
...
asn_TYPE_descriptor_t asn_DEF_systemInfoModification_3 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_systemInfoModification_constr_3,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_descriptor_t asn_DEF_etws_Indication_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_etws_Indication_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
...
asn_TYPE_member_t asn_MBR_EUTRA_RRC_Definitions_Paging_1[] = {
	{ ATF_POINTER, 4, offsetof(struct EUTRA_RRC_Definitions_Paging, pagingRecordList),
	...
	{ ATF_POINTER, 3, offsetof(struct EUTRA_RRC_Definitions_Paging, systemInfoModification),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct EUTRA_RRC_Definitions_Paging, etws_Indication),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_RRC_Definitions_Paging, nonCriticalExtension),
...
static const int asn_MAP_EUTRA_RRC_Definitions_Paging_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EUTRA_RRC_Definitions_Paging_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_EUTRA_RRC_Definitions_Paging_specs_1 = {
	sizeof(struct EUTRA_RRC_Definitions_Paging),
	offsetof(struct EUTRA_RRC_Definitions_Paging, _asn_ctx),
	asn_MAP_EUTRA_RRC_Definitions_Paging_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_EUTRA_RRC_Definitions_Paging_oms_1,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_EUTRA_RRC_Definitions_Paging = {
	"Paging",
	"Paging",
	&asn_OP_SEQUENCE,
	asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1,
	sizeof(asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1[0]), /* 1 */
	asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1,	/* Same as above */
	sizeof(asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1)
		/sizeof(asn_DEF_EUTRA_RRC_Definitions_Paging_tags_1[0]), /* 1 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
	...
	asn_MBR_EUTRA_RRC_Definitions_Paging_1,
	4,	/* Elements count */
	&asn_SPC_EUTRA_RRC_Definitions_Paging_specs_1	/* Additional specs */
};
